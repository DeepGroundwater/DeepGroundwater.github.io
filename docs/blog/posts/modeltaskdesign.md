...
Example 1: The Short-Range Umbrella
This is the "Gold Standard" of modeling. You want to stay dry on your walk to work. You use a short-range weather model to see if it will rain in the next hour.
...
<p align="center">
  <img src="https://raw.githubusercontent.com/DeepGroundwater/DeepGroundwater.github.io/master/docs/blog/posts/pics/taskumbrella.png" alt="Should I bring an umbrella to work" width="300"/>
</p>


Example 2: The Packing Paradox
...
<p align="center">
  <img src="https://raw.githubusercontent.com/DeepGroundwater/DeepGroundwater.github.io/master/docs/blog/posts/pics/taskpack.png" alt="What should I bring on my trip" width="300"/>
</p>


Example 3: Solving Flooding (The Alignment Trap)
This is where things get dangerous in professional hydrology. We often set out with a massive, virtuous goal: Eliminate flood hazards. But how do we translate that into a computational task? Usually, we produce a 100-year flood map.
...
<p align="center">
  <img src="https://raw.githubusercontent.com/DeepGroundwater/DeepGroundwater.github.io/master/docs/blog/posts/pics/taskflood.png" alt="Let's solve flooding" width="300"/>
</p>
